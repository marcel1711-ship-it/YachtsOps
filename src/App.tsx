...
const AppContent: React.FC = () => {
  ...
  // Location view is a standalone mobile-optimized page — no sidebar/header shell
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:ml-64">
        <Header onNavigate={handleNavigate} onMenuToggle={() => setMobileSidebarOpen(prev => !prev)} />
