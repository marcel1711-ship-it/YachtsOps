...
import { Bell, User, LogOut, ChevronDown, Ship, Settings } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ onNavigate }) => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 h-16 fixed top-0 left-64 right-0 z-10 shadow-sm">
