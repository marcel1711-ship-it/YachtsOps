      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          {onClose && (
            <button
              onClick={onClose}
              className="p-1.5 rounded-xl hover:bg-gray-100 transition-colors text-gray-500 lg:hidden"
...
export const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate, mobileOpen = false, onMobileClose }) => {
  return (
    <>
      {/* Desktop sidebar */}
