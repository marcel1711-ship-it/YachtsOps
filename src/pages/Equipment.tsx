  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Equipment Management</h1>
          <p className="text-gray-500 mt-2 text-base">Manage vessel equipment and systems</p>
        </div>
        <button
