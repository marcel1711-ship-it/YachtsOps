  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-4xl font-bold text-gray-900 tracking-tight">Fuel & Consumables</h1>
          <p className="text-gray-500 mt-1 sm:mt-2 text-sm sm:text-base">Track fuel, water and operational fluid levels</p>
        </div>
