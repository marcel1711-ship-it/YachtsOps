...
import { History as HistoryIcon, Search, CheckCircle, Calendar, User, Filter, ChevronDown, FileDown, Image, X, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    ...
    {lightbox && (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-4xl font-bold text-gray-900 tracking-tight">Maintenance History</h1>
          <p className="text-gray-500 mt-1 sm:mt-2 text-sm sm:text-base">Complete audit trail of all maintenance activities</p>
        </div>
        <button
          onClick={handleExportPDF}
          disabled={filtered.length === 0}
          className="flex items-center gap-2 px-5 py-3 bg-white border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-40 disabled:cursor-not-allowed shrink-0 self-start sm:self-auto"
        >
