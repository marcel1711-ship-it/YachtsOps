  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Maintenance Tasks</h1>
          <p className="text-gray-500 mt-2 text-base">Manage preventive maintenance schedule</p>
        </div>
        <button
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className={`px-3 py-1 rounded-lg text-xs font-medium ${getTaskStatusColor(task.status)}`}>
                      ...
                      <div className="text-right ml-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">{formatDate(task.next_due_date)}</p>
                        {task.status === 'overdue' && (
