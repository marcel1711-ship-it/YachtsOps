  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Maintenance Manuals</h1>
          <p className="text-gray-500 mt-2 text-base">Equipment documentation and service manuals</p>
        </div>
        <button
